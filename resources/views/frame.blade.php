  ...
  <div class="container common-bg">
    <div class="row">
	  <div class="col-md-12 word-block">
		<h1 class="wow fadeInDown">阿佈故事框</h1>
		<div class="wow fadeInUp">
		  <p>用框的方式，封存单一色调里的昔日情愫，</P>
		  <p>我们用心聆听，贴心制作。</P>
...
<section id="show">
  <div class="container">
    <div class="row common-bg frame-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-1.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-2.png" /></div>
			</div>
    </div>
    <div class="row common-bg frame-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-3.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-4.png" /></div>
			</div>
    </div>
		<div class="row common-bg frame-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-5.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-6.png" /></div>
			</div>
    </div>
	<!--
		<div class="row common-bg frame-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-7.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-8.png" /></div>
			</div>
    </div>
		<div class="row common-bg frame-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-9.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/frame-10.png" /></div>
			</div>
    </div>
	-->
		<div class="row">
			<div class="pro-img-wrap left col-md-12">
				<div class="wow zoomIn">
					<img  class="img-responsive" src="/static/img/frame-11.png" /></div>
			</div>
		</div>
  </div>
</section>
