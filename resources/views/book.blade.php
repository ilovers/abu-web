  ...
  <div class="container common-bg">
    <div class="row">
	  <div class="col-md-12 word-block">
		<h1 class="wow fadeInDown">阿佈故事书</h1>
		<div class="wow fadeInUp">
		  <p>用书的方式，定格历经时间沉淀后的隽永记忆，</P>
		  <p>我们用心聆听，贴心制作。</P>
...
<section id="show">
  <div class="container">
    <div class="row common-bg book-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-1.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-2.png" /></div>
			</div>
    </div>
    <div class="row common-bg book-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-3.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-4.png" /></div>
			</div>
    </div>
		<div class="row common-bg book-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-5.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-6.png" /></div>
			</div>
    </div>
		<div class="row common-bg book-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-7.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-8.png" /></div>
			</div>
    </div>
		<div class="row common-bg book-row">
			<div class="pro-img-wrap left col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-9.png" /></div>
			</div>
			<div class="pro-img-wrap right col-md-6 col-xs-12">
				<div class="wow zoomIn">
					<img src="/static/img/book-10.png" /></div>
			</div>
    </div>
		<div class="row">
